// ======================================================================
// 74374_OctalDFlipFlop.v generated from TopDesign.cysch
// 01/17/2022 at 15:55
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_dffe_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_dffe_v1_0\cy_dffe_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_dffe_v1_0"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_dffe_v1_0\cy_dffe_v1_0.v"
`endif
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b32a850d-f93d-451f-9fcc-d2e2b0f4d961"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_nEN_net;
	wire [0:0] tmpFB_0__Pin_nEN_net;
	wire [0:0] tmpIO_0__Pin_nEN_net;
	wire [0:0] tmpINTERRUPT_0__Pin_nEN_net;
	electrical [0:0] tmpSIOVREF__Pin_nEN_net;

	cy_psoc3_pins_v1_10
		#(.id("12613c94-766f-465d-a888-c5f79663c3f9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_nEN
		 (.oe(tmpOE__Pin_nEN_net),
		  .y({Net_53}),
		  .fb({tmpFB_0__Pin_nEN_net[0:0]}),
		  .io({tmpIO_0__Pin_nEN_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_nEN_net),
		  .interrupt({tmpINTERRUPT_0__Pin_nEN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_nEN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [7:0] tmpOE__Port_Q_net;
	wire [7:0] tmpIO_7__Port_Q_net;
	wire [0:0] tmpINTERRUPT_0__Port_Q_net;
	electrical [0:0] tmpSIOVREF__Port_Q_net;
	...
	cy_psoc3_pins_v1_10
		...
		Port_Q
		 (.oe(tmpOE__Port_Q_net),
		  .y({8'b0}),
		  .fb({Net_213[7:0]}),
		  .io({tmpIO_7__Port_Q_net[7:0]}),
		  .siovref(tmpSIOVREF__Port_Q_net),
		  .interrupt({tmpINTERRUPT_0__Port_Q_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Port_Q_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};

	wire [7:0] tmpOE__Port_D_net;
	wire [7:0] tmpFB_7__Port_D_net;
	wire [7:0] tmpIO_7__Port_D_net;
	wire [0:0] tmpINTERRUPT_0__Port_D_net;
	electrical [0:0] tmpSIOVREF__Port_D_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(16'b00_00_00_00_00_00_00_00))
		Port_D
		 (.oe(tmpOE__Port_D_net),
		  .y({Net_149[7:0]}),
		  .fb({tmpFB_7__Port_D_net[7:0]}),
		  .io({tmpIO_7__Port_D_net[7:0]}),
		  .siovref(tmpSIOVREF__Port_D_net),
		  .interrupt({tmpINTERRUPT_0__Port_D_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Port_D_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};

    // -- DFFE Start --
    reg  cy_dffe_7;
    always @(posedge Net_173)
    begin
        cy_dffe_7 <= Net_140 ? Net_149[6] : cy_dffe_7;
    end
    assign Net_208 = cy_dffe_7;
    // -- DFFE End --
    ...
    always @(posedge Net_173)
    begin
        cy_dffe_6 <= Net_136 ? Net_149[5] : cy_dffe_6;
    end
    assign Net_205 = cy_dffe_6;
    // -- DFFE End --
    ...
    always @(posedge Net_173)
    begin
        cy_dffe_5 <= Net_132 ? Net_149[4] : cy_dffe_5;
    end
    assign Net_202 = cy_dffe_5;
    // -- DFFE End --
    ...
    always @(posedge Net_173)
    begin
        cy_dffe_4 <= Net_128 ? Net_149[3] : cy_dffe_4;
    end
    assign Net_199 = cy_dffe_4;
    // -- DFFE End --
    ...
    always @(posedge Net_173)
    begin
        cy_dffe_3 <= Net_124 ? Net_149[2] : cy_dffe_3;
    end
    assign Net_193 = cy_dffe_3;
    // -- DFFE End --

    CyControlReg_v1_80 D_Reg (
        .clock(1'b0),
        .control_0(Net_100),
        .control_1(Net_97),
        .control_2(Net_98),
        ...
        .control_6(Net_103),
        .control_7(Net_104),
        .control_bus(Net_149[7:0]),
        .reset(1'b0));
    defparam D_Reg.Bit0Mode = 0;
    defparam D_Reg.Bit1Mode = 0;
    defparam D_Reg.Bit2Mode = 0;
    defparam D_Reg.Bit3Mode = 0;
    defparam D_Reg.Bit4Mode = 0;
    defparam D_Reg.Bit5Mode = 0;
    defparam D_Reg.Bit6Mode = 0;
    defparam D_Reg.Bit7Mode = 0;
    defparam D_Reg.BitValue = 0;
    defparam D_Reg.BusDisplay = 1;
    defparam D_Reg.ExtrReset = 0;
    defparam D_Reg.NumOutputs = 8;

    // -- DFFE Start --
    reg  cy_dffe_1;
    always @(posedge Net_173)
    begin
        cy_dffe_1 <= Net_96 ? Net_149[0] : cy_dffe_1;
    end
    assign Net_179 = cy_dffe_1;
    // -- DFFE End --
    ...
    always @(posedge Net_173)
    begin
        cy_dffe_2 <= Net_120 ? Net_149[1] : cy_dffe_2;
    end
    assign Net_190 = cy_dffe_2;
    // -- DFFE End --

	wire [0:0] tmpOE__Pin_ERR_net;
	wire [0:0] tmpFB_0__Pin_ERR_net;
	wire [0:0] tmpIO_0__Pin_ERR_net;
	wire [0:0] tmpINTERRUPT_0__Pin_ERR_net;
	electrical [0:0] tmpSIOVREF__Pin_ERR_net;

	cy_psoc3_pins_v1_10
		#(.id("e617d128-da37-469e-a95b-df939c845f4a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_ERR
		 (.oe(tmpOE__Pin_ERR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_ERR_net[0:0]}),
		  .io({tmpIO_0__Pin_ERR_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_ERR_net),
		  .interrupt({tmpINTERRUPT_0__Pin_ERR_net[0:0]}),
		  .annotation({Net_9}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_ERR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_OK_net;
	wire [0:0] tmpFB_0__Pin_OK_net;
	wire [0:0] tmpIO_0__Pin_OK_net;
	wire [0:0] tmpINTERRUPT_0__Pin_OK_net;
	electrical [0:0] tmpSIOVREF__Pin_OK_net;

	cy_psoc3_pins_v1_10
		#(.id("f718e87c-94ae-47a5-b94d-c3a20bb378c8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_OK
		 (.oe(tmpOE__Pin_OK_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_OK_net[0:0]}),
		  .io({tmpIO_0__Pin_OK_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_OK_net),
		  .interrupt({tmpINTERRUPT_0__Pin_OK_net[0:0]}),
		  .annotation({Net_15}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_OK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    always @(posedge Net_173)
    begin
        cy_dffe_8 <= Net_144 ? Net_149[7] : cy_dffe_8;
    end
    assign Net_211 = cy_dffe_8;
    // -- DFFE End --

    CyControlReg_v1_80 C_Reg (
        .clock(1'b0),
        .control_0(Net_173),
        .control_1(Net_165),
        .control_2(Net_166),
        ...
        .control_7(Net_171),
        .reset(1'b0));
    defparam C_Reg.Bit0Mode = 0;
    defparam C_Reg.Bit1Mode = 0;
    defparam C_Reg.Bit2Mode = 0;
    defparam C_Reg.Bit3Mode = 0;
    defparam C_Reg.Bit4Mode = 0;
    defparam C_Reg.Bit5Mode = 0;
    defparam C_Reg.Bit6Mode = 0;
    defparam C_Reg.Bit7Mode = 0;
    defparam C_Reg.BitValue = 0;
    defparam C_Reg.BusDisplay = 0;
    defparam C_Reg.ExtrReset = 0;
    defparam C_Reg.NumOutputs = 1;
    ...
    assign Net_214 = ~(Net_213[0] ^ Net_179);


    assign Net_215 = ~(Net_213[1] ^ Net_190);


    assign Net_217 = ~(Net_213[2] ^ Net_193);


    assign Net_218 = ~(Net_213[3] ^ Net_199);


    assign Net_219 = ~(Net_213[4] ^ Net_202);


    assign Net_220 = ~(Net_213[5] ^ Net_205);


    assign Net_221 = ~(Net_213[6] ^ Net_208);


    assign Net_222 = ~(Net_213[7] ^ Net_211);


    assign Net_235 = Net_214 & Net_215 & Net_217 & Net_218 & Net_219 & Net_220 & Net_221 & Net_222;

    CyStatusReg_v1_90 Eq_Reg (
        .clock(Net_239),
        .intr(Net_244),
        .status_0(Net_235),
        .status_1(1'b0),
        ...
        .status_7(1'b0),
        .status_bus(8'b0));
    defparam Eq_Reg.Bit0Mode = 0;
    defparam Eq_Reg.Bit1Mode = 0;
    defparam Eq_Reg.Bit2Mode = 0;
    defparam Eq_Reg.Bit3Mode = 0;
    defparam Eq_Reg.Bit4Mode = 0;
    defparam Eq_Reg.Bit5Mode = 0;
    defparam Eq_Reg.Bit6Mode = 0;
    defparam Eq_Reg.Bit7Mode = 0;
    defparam Eq_Reg.BusDisplay = 0;
    defparam Eq_Reg.Interrupt = 0;
    defparam Eq_Reg.MaskValue = 0;
    defparam Eq_Reg.NumInputs = 1;
